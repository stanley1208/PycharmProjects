...
class LSTMRNN(object):
    ...
    def add_cell(self):
        lstm_cell = tf.compat.v1.config.rnn.BasicLSTMCell(self.cell_size, forget_bias=1.0, state_is_tuple=True)
    ...
    def compute_cost(self):
        losses = tf.compat.v1.config.legacy_seq2seq.sequence_loss_by_example(
    ...
    def _weight_variable(self, shape, name='weights'):
        ...
        return tf.compat.v1.get_variable(shape=shape, initializer=initializer, name=name)
